...
object BetaInfo {
    ...
    const val FEEDBACK_URL: String = "https://github.com/Flash-Team-1/CodeAssist/issues/new"

    /** What "Learn more" on the analytics consent prompt opens: the privacy policy. */
    const val PRIVACY_URL: String = "https://github.com/Flash-Team-1/CodeAssist/blob/main/PRIVACY.md"
    ...
    const val REPO_URL: String = "https://github.com/Flash-Team-1/CodeAssist"
}
